      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-4 lg:px-8">
        <div className="md:col-span-2">
          ...
          <p className="mt-4 max-w-xl text-sm leading-7 text-white/75">
            Fu Miao E-commerce Co., Ltd. is a China-based B2B pajama manufacturer
            supporting brands, wholesalers, distributors, importers, and
            e-commerce sellers with OEM pajama manufacturing, ODM pajama design,
        ...
        <div>
          ...
          <div className="mt-4 grid gap-3 text-sm text-white/75">
            ...
            <a className="flex items-center gap-2 hover:text-white" href={`https://wa.me/${site.whatsapp.replace(/\D/g, "")}`}>
              <MessageCircle className="h-4 w-4" aria-hidden="true" />
              WhatsApp Inquiry
            </a>
